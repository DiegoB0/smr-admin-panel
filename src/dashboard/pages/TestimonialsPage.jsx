...
function TestimonialsPage() {
  ...
  // Handle rating change (set selected rating)
  ...
  return (
    <div className="p-8 space-y-12 overflow-y-auto">
      ...
      <div className='mb-2 flex justify-between w-full'>
        ...
        <h2 className='text-xl font-bold mb-4 text-gray-900 uppercase'>Testimonios</h2>
        <button
          type="submit"
          ...
          <table className="min-w-full bg-white text-sm">
            <thead className="bg-gray-100 text-left">
              <tr>
                ...
                <th className="px-4 py-2 text-gray-600">Compañia</th>
                <th className="px-4 py-2 text-gray-600">Mensaje</th>
                <th className="px-4 py-2 text-gray-600">Rating</th>
      ...
      {isBlogFormOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-gray-900 text-white rounded-xl shadow-xl w-1/2 max-w-lg p-6 relative">
            <h3 className="text-xl font-semibold mb-4">Nuevo Testimonio</h3>
              ...
              <div className="mb-4 flex gap-4">
                ...
                <div className="w-1/2">
                  ...
                  <input
                    id="company"
                    type="text"
                    placeholder="Escribe la compañia"
                    className="w-full mt-1 p-2 bg-transparent text-white border border-gray-600 rounded-xl outline-none ring-0 focus:ring-1 focus:ring-white focus:border-white transition-all shadow-none"
                  />
                </div>
              </div>
                ...
                <div className="flex gap-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <TiStarFullOutline
                      ...
                      size={30}
                      className={`cursor-pointer ${star <= (hovered || rating)
                        ? hovered
                          ? "text-yellow-400" // Hover yellow
                          : "text-yellow-500" // Selected yellow
                        : "text-gray-500"
                        }`}
                    />
                  ))}
